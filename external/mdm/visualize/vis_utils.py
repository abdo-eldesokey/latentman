...
class npy2obj:
    def __init__(self, npy_path, sample_idx, rep_idx, gender="neutral", device=0, cuda=True):
        ...
        self.j2s = joints2smpl(num_frames=self.num_frames, device_id=device, gender=gender, cuda=cuda)
